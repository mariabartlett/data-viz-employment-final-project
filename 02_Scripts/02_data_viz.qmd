...
We calculates the employment increase rate by grouping the data by country and sector and then computing the year-over-year percentage change in the proportion of the population employed in each sector, simply: $$
