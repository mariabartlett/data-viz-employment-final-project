...
The **stacked bar chart** is the first step in our analysis, offering a bird's-eye view of **conflict distribution across regions over time**. It visualizes the total number of conflicts globally, broken down into regional contributions from 1990 to 2023. The chart serves as a foundation to contextualize the scale and dynamics of conflict activity.
