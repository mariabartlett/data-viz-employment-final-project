...
## Part3. Impact of Conflicts on unemployment By Demographic in Selected Regions
...
plot_ly() %>%
  ...
  layout(
    title = list(
      text = "Relationship between Conflicts Numbers and Unemployment Rate Southern Asia by Youth Gender",
      font = list(size = 15)  
    ),
    xaxis = list(
      title = "Year",
...
## Part 4: Impact of Conflicts on Employment By Sector in Selected Regions
